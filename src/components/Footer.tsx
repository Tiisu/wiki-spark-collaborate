  ...
  return (
    <footer className="bg-slate-800 dark:bg-slate-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Twitter className="h-5 w-5 text-slate-400 dark:text-slate-500 hover:text-blue-400 cursor-pointer transition-colors" />
              <Github className="h-5 w-5 text-slate-400 dark:text-slate-500 hover:text-blue-400 cursor-pointer transition-colors" />
              <Mail className="h-5 w-5 text-slate-400 dark:text-slate-500 hover:text-blue-400 cursor-pointer transition-colors" />
            </div>
          </div>
        ...
        <div className="border-t border-slate-700 dark:border-slate-600 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 dark:text-slate-500 text-sm">
            © 2025 WikiWalkthrough. Made with <Heart className="h-4 w-4 text-red-500 inline mx-1" /> for free knowledge.
          </p>
          <div className="flex space-x-6 text-sm text-slate-400 dark:text-slate-500 mt-4 md:mt-0">
